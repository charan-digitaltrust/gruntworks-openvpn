...
data "template_file" "user_data" {
  ...
  vars {
    ...
    assume_iam_role_arn_for_queue_access = "${module.openvpn_user_mgmt.openvpn_server_iam_role_arn}"
...
# ---------------------------------------------------------------------------------------------------------------------
# CREATE THE IAM GROUPS AND QUEUES TO MANAGE OPENVPN ACCESS
# ---------------------------------------------------------------------------------------------------------------------
...
module "openvpn_user_mgmt" {
  ...
  source = "../../modules/openvpn-user-mgmt"
